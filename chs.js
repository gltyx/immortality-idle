...
var cnItems = {
    ...
    "You attack a pesky mouse but miss.": "你攻击了一只讨厌的老鼠，但错过了。",
    "You attack a pesky mouse for 1 damage": "你攻击一只讨厌的老鼠造成 1 点伤害",
    ...
    "Uses 20 stamina. Increases strength and sometimes finds something useful.": "消耗20体力。 增加力量，有时会发现一些有用的东西。",
    "Uses 20 stamina. Increases toughness and intelligence. If you have metal ores, you can make them into bars.": "消耗20体力。 增加韧性和智力。 如果你有金属矿石，你可以将它们制成锭。",
    ...
    "Uses 50 stamina. Increases speed and a good hunt provides some meat. It might draw unwanted attention to yourself.": "消耗50体力。 提高速度和良好的狩猎提供一些肉。 它可能会引起不必要的注意。",
    "Copper Bar": "铜条",
    "Copper Ore": "铜矿",
    "Hide": "皮毛",
    "Meat": "肉",
    ...
    "A fine bed with a cover. Curtains keep the mosquitoes off you during the night. Increases daily stamina recovery by 2 and restores a bit of health.": "一张带罩子的好床。 窗帘让蚊子在夜间远离你。 每天恢复体力增加 2 点并恢复一点生命值。",
    ...
    "A thin woven mat to sleep on. Increases daily stamina recovery by 1 and restores a bit of health.": "用来睡觉的薄编织垫。 每日体力恢复增加 1 点并恢复一点生命值。",
    "Bed Of Nails": "钉床",
    "Blanket": "毯子",
    "Buy Furniture": "购买家具",
    "Canopy Bed": "华盖床",
    ...
    "A bar of tin.": "一根锡条。",
    "A terrible quality log.": "一个糟糕的质量日志。",
...
var cnPrefix = {
    ...
    "Mining": "采矿",
    "Smelting": "锻造",
    "Your aptitude for Animalhandling increased by ": "你的驯兽能力提高了 ",
    "Your aptitude for Charisma increased by ": "你的魅力天赋增加了 ",
    "Your aptitude for Earthlore increased by ": "你的 土地知识 能力提高了 ",
    "Your aptitude for Intelligence increased by ": "你的 智力天赋提高了 ",
    "Your aptitude for Metallore increased by ": "你的 金属天赋增加了 ",
    "Your aptitude for Speed increased by ": "你的速度天赋增加了 ",
    "Your aptitude for Strength increased by ": "你的力量天赋增加了 ",
    "Your aptitude for Toughness increased by ": "你的坚韧天赋增加了 ",
    "Your aptitude for Waterlore increased by ": "你的 Waterlore 天赋增加了 ",
    "Your aptitude for Woodlore increased by ": "你的 Woodlore 天赋增加了 ",
...
var cnRegReplace = new Map([
    ...
    [/^Ow! an infant spider hit you for (.+) damage$/, '哦！ 一只小蜘蛛对你造成 $1 伤害'],
    ...
    [/^An immortal must have raw physical power. Your aptitude of (.+) multiplies your gains by (.+).$/, '不朽者必须拥有原始的体力。 你 $1 的资质将你的收益乘以 $2。'],
